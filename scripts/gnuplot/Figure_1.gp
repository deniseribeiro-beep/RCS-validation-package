...
# Matrix-specific scoring boxes. Fluid and solid paths are parallel alternatives,
# not sequential stages.
set object 30 rect from 4,23 to 39,34 fc rgb "#EEF3F8" fs solid 1.0 border lc rgb "#404040" lw 1.0
set object 31 rect from 4,8 to 39,19 fc rgb "#EEF3F8" fs solid 1.0 border lc rgb "#404040" lw 1.0
set label 40 "Fluid biospecimens\nP_pre  P_cent1  P_cent2  P_post  P_store" at 21.5,28.5 center font "Helvetica,8"
set label 41 "Solid biospecimens\nP_warm  P_cold  P_fix  P_fixTime  P_store" at 21.5,13.5 center font "Helvetica,8"

set object 32 rect from 72,15 to 96,29 fc rgb "#E7F2EC" fs solid 1.0 border lc rgb "#404040" lw 1.0
set label 42 "RCS = 100 - P_bio\nOperational grade A-E" at 84,22 center font "Helvetica,8"
...
set arrow 6 from 45,44 to 21.5,34 head filled size screen 0.010,15,45 lw 1.0 lc rgb "#4A4A4A"
set arrow 7 from 55,44 to 21.5,19 head filled size screen 0.010,15,45 lw 1.0 lc rgb "#4A4A4A"
set arrow 8 from 39,28.5 to 58,23.5 head filled size screen 0.010,15,45 lw 0.9 lc rgb "#707070"
set arrow 9 from 39,13.5 to 58,20.5 head filled size screen 0.010,15,45 lw 0.9 lc rgb "#707070"
set arrow 10 from 58,22 to 72,22 head filled size screen 0.010,15,45 lw 1.0 lc rgb "#4A4A4A"

set label 60 "Admissible" at 43,39 left font "Helvetica,8"
