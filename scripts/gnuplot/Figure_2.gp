...
set xrange [0.5:6.5]
set yrange [5.5:0.5]
set xtics ("Optimal" 1, "Mild\nsuboptimal" 2, "Moderate\nsuboptimal" 3, "Severe\nsuboptimal" 4, "Critical\npenalty" 5, "Governance\nfailure" 6) font "Sans,9"
set ytics ("Grade A" 1, "Grade B" 2, "Grade C" 3, "Grade D" 4, "Grade E" 5) font "Sans,10"

set palette defined (0 "#FFFFFF", 0.02 "#E7F0FF", 0.25 "#C8DCF9", 0.50 "#94BDF4", 0.75 "#6A9FF0", 1.00 "#4589FF")
set cbrange [0:1]
set cbtics ("0" 0, "25" 0.25, "50" 0.50, "75" 0.75, "100" 1) font "Sans,9"

set label 900 "Synthetic validation scenario" at screen 0.50,0.055 center font "Sans,11"
set multiplot layout 1,2 rowsfirst margins 0.10,0.90,0.20,0.91 spacing 0.065,0.0
...
plot DATA every ::1 using ((stringcolumn("matrix") eq "fluid") ? scenario_id(stringcolumn("scenario")) : 1/0):(grade_id(stringcolumn("final_grade"))):(column("proportion")) \
         with points pointtype 5 pointsize 4.45 linecolor palette notitle, \
     DATA every ::1 using ((stringcolumn("matrix") eq "fluid") ? scenario_id(stringcolumn("scenario")) : 1/0):(grade_id(stringcolumn("final_grade"))):(column("proportion") <= 0.55 ? sprintf("%.1f",100.0*column("proportion")) : "") \
         with labels center font "Sans,9" textcolor rgb "#202020" notitle, \
     DATA every ::1 using ((stringcolumn("matrix") eq "fluid") ? scenario_id(stringcolumn("scenario")) : 1/0):(grade_id(stringcolumn("final_grade"))):(column("proportion") > 0.55 ? sprintf("%.1f",100.0*column("proportion")) : "") \
         with labels center font "Sans,9" textcolor rgb "#FFFFFF" notitle
unset label 100
...
set colorbox vertical user origin screen 0.925,0.27 size screen 0.020,0.52
