...
set xlabel "Synthetic validation scenario" offset 0,-1.25
...
set colorbox vertical user origin screen 0.925,0.245 size screen 0.018,0.545

set label 100 "Fluid biospecimens" at graph 0.23,1.055 center font "Helvetica,10"
set label 101 "Solid biospecimens" at graph 0.77,1.055 center font "Helvetica,10"
...
plot DATA every ::1 using (xpos(stringcolumn("matrix"),stringcolumn("scenario"))):(grade_id(stringcolumn("final_grade"))):(column("proportion")) \
         with points pointtype 5 pointsize 4.7 linecolor palette notitle, \
