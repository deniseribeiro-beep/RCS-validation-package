...
set format y "%.2g"
unset xlabel
set ylabel "Median elapsed time (s)" offset 0.7,0 font "Sans,9"
set key top left horizontal opaque nobox font "Sans,8"
set label 100 "A. C reference batch elapsed time" at graph 0.0,1.085 left font "Sans,9"
...
set ylabel "Median time per profile (µs)" offset 0.7,0 font "Sans,9"
set label 101 "B. Median per-profile computational cost" at graph 0.0,1.085 left font "Sans,9"
