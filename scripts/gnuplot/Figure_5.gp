...
set grid ytics
set multiplot layout 2,1 rowsfirst margins 0.13,0.975,0.12,0.93 spacing 0.0,0.15

# A. Batch elapsed time, matching the simple scalability presentation used in the manuscript.
unset logscale y
set yrange [0:*]
set format y "%.2g"
unset xlabel
set ylabel "Median elapsed time (s)" offset 0.7,0 font "Helvetica,9"
set key top left horizontal opaque nobox font "Helvetica,8"
set label 100 "A. C reference batch elapsed time" at graph 0.0,1.085 left font "Helvetica,9"
...
# B. Per-profile computational cost, analogous to the manuscript scalability figure.
unset key
set yrange [0:*]
set format y "%.2g"
set xlabel "Number of biospecimen profiles" offset 0,0.3 font "Helvetica,9"
set ylabel "Median time per profile (µs)" offset 0.7,0 font "Helvetica,9"
set label 101 "B. Median per-profile computational cost" at graph 0.0,1.085 left font "Helvetica,9"
