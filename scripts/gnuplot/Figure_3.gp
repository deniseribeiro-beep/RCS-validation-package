...
set ytics 0,10,60 font "Helvetica,8"
set ylabel "Proportion of admissible combinatorial profiles (%)" offset 0.8,0 font "Helvetica,9"
unset xlabel
set grid ytics

set label 100 "Fluid biospecimens" at first 3, first 56 center font "Helvetica,9"
set label 101 "Solid biospecimens" at first 9, first 56 center font "Helvetica,9"
