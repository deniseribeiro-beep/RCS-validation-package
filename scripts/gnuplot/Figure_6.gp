...
set logscale x 2
set xrange [0.8:20]
set xtics ("1" 1, "2" 2, "4" 4, "8" 8, "16" 16) font "Sans,7"
set yrange [0.25:1.50]
set ytics ("0.25" 0.25, "0.50" 0.50, "0.75" 0.75, "1.00" 1.00, "1.25" 1.25, "1.50" 1.50) font "Sans,7"
set grid ytics
set arrow 900 from graph 0, first 1 to graph 1, first 1 nohead dashtype 3 linewidth 0.9 linecolor rgb "#777777" back
set label 950 "Workload: 5 million biospecimen profiles" at screen 0.50,0.955 center font "Sans,8" tc rgb "#444444"
set label 951 "Parallel workers / threads" at screen 0.50,0.075 center font "Sans,9"

set multiplot layout 1,3 rowsfirst margins 0.10,0.98,0.19,0.88 spacing 0.045,0.0

# A. C++ / OpenMP
set ylabel "Speedup vs sequential (×)" offset 0.55,0 font "Sans,8"
set format y "%g"
set key bottom center horizontal opaque nobox font "Sans,7"
set label 100 "A. C++ / OpenMP" at graph 0.04,0.93 left font "Sans,8"
...
set format y ""
unset key
set label 101 "B. Cython / OpenMP" at graph 0.04,0.93 left font "Sans,8"
...
# C. R / PSOCK
set label 102 "C. R / PSOCK" at graph 0.04,0.93 left font "Sans,8"
