...
set yrange [0:80]
set ytics 0,20,80 font "Helvetica,8"
unset xlabel
set ylabel "Compute acceleration (×)" offset 0.65,0 font "Helvetica,9"
unset key
set label 100 "A. CUDA compute kernel vs C++ sequential" at graph 0.0,1.085 left font "Helvetica,9"
...
set yrange [0:1.05]
set ytics 0,0.2,1.0 font "Helvetica,8"
set xlabel "Number of biospecimen profiles" offset 0,0.3 font "Helvetica,9"
set ylabel "End-to-end relative speed (×)" offset 0.65,0 font "Helvetica,9"
set arrow 901 from graph 0, first 1 to graph 1, first 1 nohead dashtype 3 linewidth 0.9 linecolor rgb "#777777" back
set label 102 "B. CUDA end-to-end vs C++ sequential" at graph 0.0,1.085 left font "Helvetica,9"
set label 103 "1× baseline" at graph 0.985, first 0.965 right font "Helvetica,7" tc rgb "#666666"
