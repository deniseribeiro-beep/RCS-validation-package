...
set yrange [0.02:120]
set xtics ("10k" 10000, "50k" 50000, "100k" 100000, "500k" 500000, "1M" 1000000, "2M" 2000000, "5M" 5000000) font sprintf("Helvetica,%.1f", FS_SMALL) rotate by -25
...
set label 900 "1×" at graph 0.01, first 1.12 left font sprintf("Helvetica,%.1f", FS_SMALL) tc rgb "#666666"
